...
rm -rf $ARCHIVE
composer create-project --stability beta --no-install drupal/legacy-project:9.2.10 $ARCHIVE
...
composer require --no-update "ext-dom:*" cweagans/composer-patches oomphinc/composer-installers-extender 'drupal/core:9.2.10'
